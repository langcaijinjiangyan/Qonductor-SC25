...
if __name__ == "__main__":
    hybrid_main(
        ...
        spec_file="spec_6.json",
        parameters_file="parameters_6.json",
        source_rel="qslurm_workloads/hybrid_6q/quantum_approximation_optimization_algorithm_qaoa/spec_6.json",
    )
