...
Converted from `qslurm_workloads/pure_quantum/grover_no_ancilla`.
...
- `submit_2.py` builds/registers a `WorkflowImage` and can emit or submit a
...
```bash
python submit_2.py --emit-manifest
python submit_2.py --submit --shots 1024
```
