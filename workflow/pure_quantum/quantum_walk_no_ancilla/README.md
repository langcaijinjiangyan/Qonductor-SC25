# quantum_walk_no_ancilla

Converted from `qslurm_workloads/pure_quantum/quantum_walk_no_ancilla`.
...
- `submit_4.py` builds/registers a `WorkflowImage` and can emit or submit a
...
```bash
python submit_4.py --emit-manifest
python submit_4.py --submit --shots 1024
```
