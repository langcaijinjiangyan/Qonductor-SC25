#!/usr/bin/env python3
"""
VQE with Two-Local Ansatz (48 params, all-to-all CX) — Qonductor Programmatic Submission.

Converted from the legacy SLURM + MPI C implementation:
    workload_transform_needed/two_local_ansatz_with_random_parameters/
    └── two_local_ansatz_with_random_parameters_12_hybrid.c
...
LOGICAL_CIRCUIT_ID: str = "twolocalrandom_indep_qiskit_12"
QASM_FILENAME: str = "twolocalrandom_indep_qiskit_12.qasm3"
BENCHMARK: str = "vqe_two_local"
ALGORITHM_TAG: str = "two_local"
